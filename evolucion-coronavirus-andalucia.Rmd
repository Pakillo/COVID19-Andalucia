...
prop.ci <- function(pos, n) {
  ...
  int.95 <- estimate + qnorm(c(.005,.995)) * se
  int.95
...
ggplot(andal) +
  ...
  labs(x = "", y = "Porcentaje de tests positivos\n",
       ...
       caption = "Los números indican el número de test realizados cada día. \nEl sombreado representa el intervalo de confianza al 99%") +
  theme(plot.caption = element_text(size = 9, colour = "grey60"))
