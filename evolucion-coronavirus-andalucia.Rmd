---
title: "Evolución de la enfermedad COVID-19 causada por el coronavirus SARS-CoV2 en Andalucía"
output: 
  html_document: 
    fig_caption: yes
    fig_height: 5
...
casos.edad.sexo <- read_csv2("datos/datos_casos_edad_sexo.csv",
                          locale = locale(date_names = "es", 
                                          decimal_mark = ",",
                                          grouping_mark = "."),
                          skip_empty_rows = TRUE) %>%
...
hosp.edad.sexo <- read_csv2("datos/datos_hosp_edad_sexo.csv",
                          locale = locale(date_names = "es", 
                                          decimal_mark = ",",
                                          grouping_mark = "."),
                          skip_empty_rows = TRUE) %>%
...
uci.edad.sexo <- read_csv2("datos/datos_uci_edad_sexo.csv",
                          locale = locale(date_names = "es", 
                                          decimal_mark = ",",
                                          grouping_mark = "."),
                          skip_empty_rows = TRUE) %>%
...
def.edad.sexo <- read_csv2("datos/datos_def_edad_sexo.csv",
                          locale = locale(date_names = "es", 
                                          decimal_mark = ",",
                                          grouping_mark = "."),
                          skip_empty_rows = TRUE) %>%
...
recup.edad.sexo <- read_csv2("datos/datos_curados_edad_sexo.csv",
                          locale = locale(date_names = "es", 
                                          decimal_mark = ",",
                                          grouping_mark = "."),
                          skip_empty_rows = TRUE) %>%
