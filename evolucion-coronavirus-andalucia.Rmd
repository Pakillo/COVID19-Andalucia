...
ggplot(distritos.data) +
  ...
  geom_line(aes(group = nombre, colour = nombre), size = 1.5) +
  geom_point(data = distritos.last, aes(colour = nombre), size = 1.5) +
  scale_color_manual(values = sample(colorRampPalette(RColorBrewer::brewer.pal(n = 9, "Set1")[-6])(35))) +
  theme(legend.position = "none") +
  ggrepel::geom_text_repel(data = distritos.last,
                           aes(label = nombre.corto, colour = nombre), 
