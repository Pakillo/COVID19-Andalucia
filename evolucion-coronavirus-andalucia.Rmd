...
ggplot(casos.pcr) +
  ...
  labs(x = "", y = "Nuevas detecciones\n",
       title = "Casos de COVID-19 confirmados diariamente mediante PCR en Andalucía",
...
Además de PCR, la Junta de Andalucía está realizando test de anticuerpos, que sirven para detectar personas que han sido probablemente contagiadas por el virus, aunque actualmente puedan no mostrar síntomas o no tener carga viral significativa. Las gráficas de abajo incluyen tanto los casos detectados mediante PCR como mediante test serológicos (anticuerpos).
