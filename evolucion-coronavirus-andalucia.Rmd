...
```{r seguimiento_Andalucía, fig.height=3, out.width='100%'}
...
```{r seguimiento_provincias, out.width='100%'}
...
Número de personas que han recibido el alta tras estar ingresadas en centros hospitalarios por COVID-19.

<br>


```{r altas_Andalucía, fig.height=3, out.width='100%'}
