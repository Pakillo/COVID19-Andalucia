...
ggplot(camas) +
  ...
  scale_x_date(date_breaks = "1 month", date_labels = "%b", 
               limits = c(as.Date("2020-04-05"), NA), expand = c(0, 30))
...
mapa <- muni.dia %>% 
  ...
  labs(title = "Porcentaje de población fallecida por municipio",
       subtitle = "Importante: Este mapa solo tiene en cuenta los fallecimientos oficiales por COVID",
       caption = "https://tiny.cc/COVID19-Andalucia")
