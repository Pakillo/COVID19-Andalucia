...
muni.data <- readr::read_csv("datos/municipios.csv", guess_max = 200000) %>%
  ...
  mutate(Confirmados.PCR.TA.14d = ifelse(Confirmados.PCR.TA.14d < 1, NA, as.integer(Confirmados.PCR.TA.14d)))
...
ggplot(hosp.edad) +
  ...
  labs(x = "Edad (años)", y = "", 
       ...
       subtitle = paste0("Total de ingresados = ", sum(hosp.edad$n), ". Datos con fecha ", fecha.edad),
       caption = "https://tiny.cc/COVID19-Andalucia")
