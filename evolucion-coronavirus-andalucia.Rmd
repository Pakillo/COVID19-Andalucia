...
ggplot() +
  ...
  theme(panel.grid.minor.y = element_line(size = rel(0.5))) +
  scale_x_date(date_breaks = "2 days", date_labels = "%d %B") +
  geom_text(aes(Fecha, y = ConfirmadosPCR + 8, label = ConfirmadosPCR),
...
Mientras que en los meses de Marzo a Mayo la inmensa mayoría de casos detectados tenían más de 30 años, en las últimas semanas la mayoría de casos corresponde a personas más jóvenes (15 a 65 años).

<br>


```{r casos.edad.fecha, out.width='100%', fig.height=3}
