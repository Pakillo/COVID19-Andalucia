...
Este mapa de nuevos casos confirmados en los últimos 14 días es útil para saber dónde se encuentran los brotes activos en la actualidad:
...
ggplot(muni.14d) +
  geom_sf(aes(fill = ConfirmadosPCR14d), colour = "grey85", size = 0.1) +
