...
indic.color.riesgo <- Vectorize(function(value) {
  
  ri.color <- data.frame(
    ri = c("NORMAL", "BAJO", "MEDIO", "ALTO", "EXTREMO"),
    colores = c("#4daf4a4D", "#ffff334D", "#ff7f004D", "#e41a1c4D", "#984ea34D")
  )
  
  color <- ri.color$colores[ri.color$ri == value]
