...
Datos referidos al `r unique(datos.indic$Fecha)` (último [informe](https://www.mscbs.gob.es/profesionales/saludPublica/ccayes/alertasActual/nCov/situacionActual.htm?q=service/) del Ministerio de Sanidad)
...
ggplot(camas) +
  ...
  annotate("text", x = max(camas.last$Fecha) + 15, y = camas.last$CamasUCI,
