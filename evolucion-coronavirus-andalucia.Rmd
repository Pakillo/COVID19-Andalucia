...
Aquí se representan los mismos datos (casos diarios confirmados por categoría de edad) usando medias móviles a 14 días para reducir la variación diaria y facilitar la visualización de tendencias:
...
ggplot(casos.edad.fecha) +
  tidyquant::geom_ma(aes(Fecha, Casos, colour = edades), ma_fun = SMA, n = 14,
                     show.legend = TRUE, linetype = "solid", size = 1.5) +
...
ggplot(casos.edad.fecha) +
  tidyquant::geom_ma(aes(Fecha, IA.14d, colour = edades), ma_fun = SMA, n = 14,
                     show.legend = TRUE, linetype = "solid", size = 1.5) +
