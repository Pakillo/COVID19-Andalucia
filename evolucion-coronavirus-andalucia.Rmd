...
ggplot(camas) +
  ...
  annotate("text", x = max(camas.last$Fecha) + 21, y = camas.last$CamasOcup, 
           label = paste0("Total ", camas.last$CamasOcup), colour = "#377eb8") +
  annotate("text", x = max(camas.last$Fecha) + 20, y = camas.last$CamasUCI,
...
ggplot(hosp.edad) +
  ...
  geom_text(aes(x = edades.f, y = n + 150, label = n), size = 3) +
  labs(x = "Edad (años)", y = "", 
